# {{STYLE_NAME}} style project

Created: {{CREATED_AT}}

- Reference pack: `{{STYLE_SLUG}}_PROJECT_PACK`
...
All artistic roles remain `REVIEW_REQUIRED` until a visual inspection is completed. Exact duplicates are retained in the source archive and recorded in the duplicate log.
