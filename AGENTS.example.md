...
- Treat every `*_PROJECT_PACK`, `*_GENERATIONS`, `BODY_REFERENCE_LIBRARY`, `GENERATION_RESULTS`, source collection, and image as local user data that must not be committed.
