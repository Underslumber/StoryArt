...
- `GENERATION_RESULTS` — архивные копии созданных и отредактированных изображений. Архивирование, доступность файла в рабочем запросе, доставка пользователю, QA и завершение задачи учитываются отдельно.
...
шаблона `config\codex.project.example.toml`: Luna Medium для обычной работы с изображениями
и Luna High для ограниченного поиска метаданных. Обычно помощников 0–1, предел — 2.
